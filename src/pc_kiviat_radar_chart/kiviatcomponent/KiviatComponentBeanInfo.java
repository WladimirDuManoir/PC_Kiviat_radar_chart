 ...
 */
public class KiviatComponentBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
        BeanDescriptor desc = new BeanDescriptor(AxisComponent.class);
        desc.setDisplayName("Kiviat");
        desc.setShortDescription("An radar chart diagram");
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_model] = new PropertyDescriptor ( "model", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, null, "setModel" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_paint92] = new MethodDescriptor(pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class.getMethod("paint", new Class[] {java.awt.Graphics.class})); // NOI18N
            ...
            methods[METHOD_setBounds128] = new MethodDescriptor(pc_kiviat_radar_chart.kiviatcomponent.KiviatComponent.class.getMethod("setBounds", new Class[] {int.class, int.class, int.class, int.class})); // NOI18N
        ...
        switch (iconKind) {
            case ICON_COLOR_16x16:
                if (iconNameC16 == null) {
                    ...
                    if (iconColor16 == null) {
                        iconColor16 = loadImage("/ressources/Icon_18-512.png");
                    }
                    return iconColor16;
                }
            case ICON_COLOR_32x32:
                if (iconNameC32 == null) {
                    ...
                    if (iconColor32 == null) {
                        iconColor32 = loadImage("/ressources/Icon_18-512.png");
                    }
                    return iconColor32;
                }
            case ICON_MONO_16x16:
                if (iconNameM16 == null) {
                    ...
                    if (iconMono16 == null) {
                        iconMono16 = loadImage("/ressources/Icon_18-512.png");
                    }
                    return iconMono16;
                }
            case ICON_MONO_32x32:
                if (iconNameM32 == null) {
                    ...
                    if (iconMono32 == null) {
                        iconMono32 = loadImage("/ressources/Icon_18-512.png");
                    }
                    return iconMono32;
                }
            default:
