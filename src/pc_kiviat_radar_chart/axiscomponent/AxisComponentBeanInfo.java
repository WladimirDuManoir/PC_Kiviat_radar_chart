 ...
 */
public class AxisComponentBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( pc_kiviat_radar_chart.axiscomponent.AxisComponent.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
        BeanDescriptor desc = new BeanDescriptor(AxisComponent.class);
        desc.setDisplayName("AxisComponent");
        desc.setShortDescription("An Axis component that works within a Kiviat");
    ...
    private static final int PROPERTY_angle = 5;
    private static final int PROPERTY_autoscrolls = 6;
    private static final int PROPERTY_axisName = 7;
    ...
    private static final int PROPERTY_valueCoordinates = 98;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_angle] = new PropertyDescriptor ( "angle", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, null, "setAngle" ); // NOI18N
            properties[PROPERTY_angle].setDisplayName ( "angle" );
            properties[PROPERTY_angle].setShortDescription ( "The angle of the axis" );
            properties[PROPERTY_angle].setConstrained ( true );
            properties[PROPERTY_angle].setPropertyEditorClass ( AxisComponent.class );
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_axisName] = new PropertyDescriptor ( "axisName", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getAxisName", "setAxisName" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_max] = new PropertyDescriptor ( "max", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getMax", "setMax" ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_min] = new PropertyDescriptor ( "min", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getMin", "setMin" ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_value] = new PropertyDescriptor ( "value", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getValue", "setValue" ); // NOI18N
            properties[PROPERTY_valueCoordinates] = new PropertyDescriptor ( "valueCoordinates", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getValueCoordinates", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "getY", null ); // NOI18N
        }
    ...
    private static final int EVENT_axisListener = 0;
    private static final int EVENT_inputMethodListener = 1;
    private static final int EVENT_keyListener = 2;
    private static final int EVENT_mouseListener = 3;
    private static final int EVENT_mouseMotionListener = 4;
    private static final int EVENT_mouseWheelListener = 5;
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_axisListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "axisListener", pc_kiviat_radar_chart.axiscomponent.AxisListener.class, new String[] {"axisChanged"}, "addAxisListener", "removeAxisListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( pc_kiviat_radar_chart.axiscomponent.AxisComponent.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_contains16] = new MethodDescriptor(pc_kiviat_radar_chart.axiscomponent.AxisComponent.class.getMethod("contains", new Class[] {int.class, int.class})); // NOI18N
            ...
            methods[METHOD_paint92] = new MethodDescriptor(pc_kiviat_radar_chart.axiscomponent.AxisComponent.class.getMethod("paint", new Class[] {java.awt.Graphics.class})); // NOI18N
            ...
            methods[METHOD_setBounds128] = new MethodDescriptor(pc_kiviat_radar_chart.axiscomponent.AxisComponent.class.getMethod("setBounds", new Class[] {int.class, int.class, int.class, int.class})); // NOI18N
    ...
    private static String iconNameC16 = "/ressources/Silverlight_0022_slider.jpg";//GEN-BEGIN:Icons
    private static String iconNameC32 = "/ressources/Silverlight_0022_slider.jpg";
